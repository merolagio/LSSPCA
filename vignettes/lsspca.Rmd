...
```
The matrices of loadings and contributions can be printed with 
```{r displayLoads}
...
```
## plots
SPCs can be visaulized in different ways. Barplot of the contribution can be created, for example, as follows
